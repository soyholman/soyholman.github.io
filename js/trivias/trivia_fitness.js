var QUESTIONS = [
  {
    question:
      "¿Cuánto tiempo de cardio se recomienda hacer para bajar de peso?",
    answers: ["25 minutos", "35 minutos", "45 minutos", "1 hora"],
    correctAnswer: "45 minutos",
    image:
      "https://www.dir.cat/blog/wp-content/uploads/2019/06/ejercicios-cardio-squat.gif",
  },
  {
    question:
      "El ejercicio cardiovascular: ¿antes o después del entrenamiento de pesas?",
    answers: [
      "Se recomienda después del entrenamiento de pesas",
      "Se recomienda antes del entrenamiento de pesas",
      "Da igual, lo importante es hacerlo",
    ],
    correctAnswer: "Se recomienda después del entrenamiento de pesas",
    image:
      "https://img.playbuzz.com/image/upload/ar_1.5,c_crop/q_auto:good,f_auto,fl_lossy,w_640,c_limit,dpr_1/v1540767027/as9iepmwrdupbviwx2b2.jpg",
  },
  {
    ...
    correctAnswer: "Falso",
    image:
      "https://img.buzzfeed.com/buzzfeed-static/static/2017-01/3/7/asset/buzzfeed-prod-fastlane-01/anigif_sub-buzz-4249-1483444852-2.gif",
  },
  {
  ...
  {
    question:
      "Las mujeres no pueden levantar mucho peso porque entonces desarrollarían el cuerpo de un hombre. ¿Mito o realidad?",
    answers: ["Mito", "Realidad"],
    correctAnswer: "Mito",
    image:
      "https://i.pinimg.com/originals/99/8b/f1/998bf1db1b90c2c3752c92fa237cc28c.gif",
  },
  {
  ...
  },
  {
    ...
    correctAnswer: "Falso",
    image:
      "https://static.wixstatic.com/media/195074_893f083b518a49cb8e111e7160f1a451~mv2.gif/v1/fill/w_400,h_500,al_c,q_90/file.jpg",
  },
  {
    question:
      "1 kilogramo de grasa ocupa 3 veces el espacio de 1 kilogramo de músculo.",
  ...
  {
    question:
      "¿Cuántos kilos en agua pueden aumentar las mujeres durante su período menstrual?",
    ...
    $("#answers")
      ...
      .click(function () {
        ...
        if ($(this).text() === correctAnswerElement.text()) {
          ...
          $("#imageTrivia").attr(
            "src",
            "https://images.angelpub.com/2016/35/39703/wrong.gif"
          );
        }
