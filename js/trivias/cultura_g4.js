var QUESTIONS = [
  {
    ...
    image:
      "https://canastadeverduras.com/wp-content/uploads/2020/10/propiedades-del-cilantro.jpg",
  },
  {
  ...
  {
    question:
      "¿Por qué los jardineros de 'Alicia en el país de las maravillas' pintan las rosas del jardín real de color rojo?",
    answers: [
      "Porque están enamorados",
      "Es una manía de la Reina de Corazones",
      "Para que la Reina no descubriera que eran blancas",
    ],
    correctAnswer: "Para que la Reina no descubriera que eran blancas",
    image:
      "https://observandoelparaiso.files.wordpress.com/2014/03/disney13-alicia3.jpg?w=584",
  },
  {
    question:
      "Según el inventor Thomas Edison, ¿qué está compuesto por 1% de inspiración y 99% de transpiración?",
  ...
  {
    question:
      "¿Cuántas veces cabría aproximadamente el territorio de El Salvador sobre el territorio de Canadá?",
  ...
  {
    question:
      "¿En qué país se encuentra la segunda línea ferroviaria más alta del mundo?",
  ...
  },
  {
    ...
    image:
      "https://www.gifsanimados.org/data/media/165/futbol-americano-y-futbol-imagen-animada-0093.gif",
  },
  {
    question:
      "¿Cuál de los siguientes países fue el último en declarar su independencia en la América española?",
    answers: ["Cuba", "Venezuela", "México"],
    correctAnswer: "Cuba",
    image:
      "https://i.pinimg.com/originals/09/a7/88/09a7881482e04f1f621280158f747677.gif",
  },
  {
    ...
    image:
      "https://media4.giphy.com/media/x0TvRjdsXKFsk/giphy.gif?cid=790b76113acc62f1c48fd5e1c2d94a225ac4b27b5f8d62f3&rid=giphy.gif&ct=g",
  },
];
