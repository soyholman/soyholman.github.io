var QUESTIONS = [
  {
    question:
      "¿Si hubiese una ola de terremotos de gran magnitud en la Tierra, cuál sería el país más seguro para resguardarse?",
  ...
  {
    question:
      "¿De llegar a haber una crisis climática, con climas extremos en todo el mundo, cuál sería el país más seguro para permanecer?",
    answers: ["Lituania", "Francia", "Noruega"],
    correctAnswer: "Noruega",
    image:
      "https://www.elindependiente.com/wp-content/uploads/2019/03/llamarada-solar.gif",
  },
  {
    question:
      "¿Qué país está mejor preparado para resistir el brote de una pandemia de proporciones cataclísmicas?",
    answers: ["Inglaterra", "Estados Unidos", "Alemania"],
    correctAnswer: "Estados Unidos",
    image:
      "https://i.pinimg.com/originals/96/f1/6e/96f16ebdf8ba8261ccd5369201d54ed9.gif",
  },
  {
    question:
      "¿Si llegara a esparcirse una infección de zombis por el mundo, en qué país tendrías las mejores posibilidades de sobrevivir?",
  ...
  {
    question:
      "¿En caso de haber un desastre nuclear, cuál sería el mejor país para resguardarse?",
  ...
  {
    question:
      "¿Si una lluvia de asteroides pone en riesgo la vida en la Tierra, cuál sería el mejor país para estar?",
  ...
  {
    question:
      "¿Qué país está mejor preparado para soportar la devastación de un tsunami?",
    answers: ["Malasia", "Indonesia", "Japón"],
    correctAnswer: "Japón",
    image:
      "https://i.kinja-img.com/gawker-media/image/upload/t_original/dauvfqx2gusqyyqtch3o.gif",
  },
];
