var QUESTIONS = [
  {
    question:
      "En este país se acostumbra luego de ofrecer un brindis, mirar a los ojos a las personas con las que brindaste mientras bebes…",
  ...
  {
    question:
      "Si quieres buscar trabajo en este país no debes colocar información personal (sexo, fecha de nacimiento, estado marital e incluso foto de perfil) en tu CV…  ",
  ...
  {
    question:
      "En este país se prohibió en el 2015 el uso de prendas de vestir de color amarillo…",
  ...
  {
    question:
      "La cultura de este país establece que luego de las comidas principales se debe beber vino tinto acompañado de una degustación de queso…",
  ...
  {
    question:
      "En este país asiático es de mala educación soplarse o limpiarse la nariz con fuerza mientras se está en público o acompañado…",
  ...
  {
    question:
      "La costumbre de sentarse en familia unos minutos antes de emprender un viaje es muy importante en este país… ",
    answers: ["Uruguay", "Australia", "Ucrania"],
    correctAnswer: "Ucrania",
    text: "El hacer esto significa recibir buena suerte durante el viaje.",
    image:
      "https://www.edreams.com/blog/wp-content/uploads/sites/3/2016/03/fly-travel-plane.gif",
  },
  {
    question:
      "País donde se puede ver en las calles a dos hombres caminando agarrados de la mano como señal de amistad…",
    ...
    image:
      "https://img.playbuzz.com/image/upload/ar_1.5,c_crop/q_auto:good,f_auto,fl_lossy,w_640,c_limit,dpr_1/v1553003268/hdzlpfkyecbnpxww59cl.jpg",
  },
  {
    question:
      "Se considera de mala educación usar la mano izquierda para comer y para otras actividades en este país…",
  ...
  {
    question:
      "La costumbre de este país es que en la celebración de año nuevo se debe saltar sobre 7 olas en el mar, pidiendo un deseo por cada ola…",
  ...
  {
    question:
      "Se dice que en este país toparse con una monja en la calle es señal de muerte… ",
