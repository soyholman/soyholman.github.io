var QUESTIONS = [
  {
    ...
    answers: [
      ...
      "1.400 gramos aproximadamente",
      "6.500 gramos aproximadamente",
    ],
  ...
  },
  {
    ...
    image:
      "https://www.elkilombonews.com/wp-content/uploads/2019/09/tenor-20.gif",
  },
  {
    question:
      "Cuál es la región del cerebro encargada de gestionar la emociones?",
    ...
    image:
      "https://qph.fs.quoracdn.net/main-qimg-353a8b0d4da9269ab2ce1d487efb1230",
  },
  {
    question:
      "Por las funciones que realiza, es muy habitual comparar el cerebro humano con el funcionamiento de una computadora ¿Sabes, comparativamente con un ordenador, a que velocidad se producen todos estos procesos en el interior de nuestra cabeza?",
  ...
  {
    question:
      "También en él guardamos información, recuerdos. Si seguimos comparando nuestro cerebro con un ordenador ¿Sabrías decir de cuánta memoria dispone un cerebro humano?",
    answers: [
      "Entre 1-10 terabytes",
      "Entre 10 – 100 terabytes",
      "Aproximadamente 1 millón de terabytes",
    ],
    ...
    image:
      "https://media3.giphy.com/media/aohvgsGTzqqYg/giphy.gif?cid=dc79c3575a85cbaf5655587149ea1ebc",
  },
  {
    question:
      "¿Sabes cómo se llama el proceso que permite que la información viaje por el cerebro?",
  ...
  {
    question:
      "Sabemos que el cerebro de un ser humano comienza a formarse a partir de los 18 días de gestación. Desde entonces no para de crecer y madurar, hasta que llegada cierta edad comienza a deteriorarse poco a poco ¿Sabes a que edad alcanza la madurez nuestro órgano director?",
